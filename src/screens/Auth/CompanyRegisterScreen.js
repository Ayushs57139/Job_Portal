    ...
    <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <LinearGradient
          ...
          style={styles.header}
        >
          <Ionicons name="business" size={32} color="#fff" style={styles.headerIcon} />
          <Text style={styles.headerTitle}>Company Registration Form</Text>
          <Text style={styles.headerSubtitle}>Let's Get Started, Tell Us about Your Company</Text>
          <View style={styles.badge}>
            <Text style={styles.badgeText}>Direct Employer</Text>
          </View>
        </LinearGradient>
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.loginContainer}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Login', { userType: 'employer', employerType: 'company' })}>
