  ...
  if (loading && applications.length === 0) {
    return (
      <View style={dynamicStyles.loadingContainer}>
        ...
        <Text style={dynamicStyles.loadingText}>Loading applied jobs...</Text>
      </View>
    );
  }
    ...
    <View style={dynamicStyles.container}>
      ...
      <View style={dynamicStyles.mainContent}>
        ...
        <View style={dynamicStyles.header}>
          ...
          <Text style={dynamicStyles.headerTitle}>Applied Jobs</Text>
        ...
        >
          ...
          <Animated.View style={[dynamicStyles.statsGrid, { opacity: fadeAnim }]}>
            <View style={dynamicStyles.statCard}>
              <View style={[dynamicStyles.statIconContainer, { backgroundColor: '#3b82f6' }]}>
                <Ionicons name="paper-plane" size={isPhone ? 20 : 24} color="#FFFFFF" />
              </View>
              <Text style={dynamicStyles.statValue}>{applications.length}</Text>
              <Text style={dynamicStyles.statLabel}>Total Applied</Text>
            </View>
            ...
            <View style={dynamicStyles.statCard}>
              <View style={[dynamicStyles.statIconContainer, { backgroundColor: '#ef4444' }]}>
                <Ionicons name="close-circle" size={isPhone ? 20 : 24} color="#FFFFFF" />
              </View>
          ...
          {filteredApplications.length === 0 ? (
            <View style={dynamicStyles.emptyState}>
              <Ionicons name="paper-plane-outline" size={isPhone ? 48 : (isMobile ? 56 : 64)} color={colors.textSecondary} />
