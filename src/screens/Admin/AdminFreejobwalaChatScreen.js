...
const AdminFreejobwalaChatScreen = ({ navigation }) => {
  ...
  return (
    <AdminLayout title="Freejobwala Chat" activeScreen="AdminFreejobwalaChat" onNavigate={handleNavigate} onLogout={handleLogout}>
      <View style={styles.container}>
        <Text style={styles.pageTitle}>Freejobwala Chat</Text>
        <Text style={styles.pageSubtitle}>Manage chat conversations</Text>
        <View style={styles.infoCard}>
          <Text style={styles.infoText}>Chat management coming soon...</Text>
        </View>
      </View>
    </AdminLayout>
  );
