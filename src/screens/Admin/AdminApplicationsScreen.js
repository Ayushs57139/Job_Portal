            ...
            <View style={styles.table}>
              ...
              {filteredApplications.length > 0 ? (
                filteredApplications.map((application, index) => {
                  ...
                  return (
                    <View key={application._id || index} style={styles.tableRow}>
                      {isMobile && <Text style={[styles.tableCellText, { fontWeight: '600', color: '#666', marginBottom: 4 }]}>Candidate:</Text>}
                      ...
                      {isMobile && <Text style={[styles.tableCellText, { fontWeight: '600', color: '#666', marginBottom: 4, marginTop: 4 }]}>Job Title:</Text>}
                      ...
                      {isMobile && <Text style={[styles.tableCellText, { fontWeight: '600', color: '#666', marginBottom: 4, marginTop: 4 }]}>Applied On:</Text>}
                ...
                <View style={styles.emptyState}>
                  <Ionicons name="document-text-outline" size={isMobile ? 48 : 64} color="#CCC" />
