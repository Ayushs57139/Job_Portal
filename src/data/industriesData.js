// Industries and Sub-Industries Data
// This data can be used across the application
// Admin can add new industries/sub-industries through backend
...
export const INDUSTRIES_DATA = [
  ...
  {
    industry: 'Agriculture / Farming / Fishing / Forestry',
    subIndustries: [
  ...
  {
    industry: 'Beauty / Fitness / Wellness',
    subIndustries: [
  ...
  {
    industry: 'Emerging Technology (ET)',
    subIndustries: [
  ...
  {
    industry: 'Health Care / Hospitals / Lifescience',
    subIndustries: [
  ...
  {
    industry: 'HR / Recruitment / Staffing',
    subIndustries: [
  ...
  {
    industry: 'Metals / Mining / Quarrying',
    subIndustries: [
  ...
  {
    industry: 'Retail / Wholesale / Consumer Goods',
    subIndustries: [
  ...
  {
    industry: 'Textile / Handicraft / Fashion',
    subIndustries: [
  ...
  },
  {
    ...
    subIndustries: ['Other Industry'],
  },
];

// Get all industries
export const getIndustries = () => {
  return INDUSTRIES_DATA.map((item) => item.industry);
};

// Get sub-industries for selected industries
export const getSubIndustries = (selectedIndustries) => {
  ...
  selectedIndustries.forEach((industry) => {
    const industryData = INDUSTRIES_DATA.find((item) => item.industry === industry);
    if (industryData) {
      subIndustries.push(...industryData.subIndustries);
    }
  });

  // Remove duplicates
  return [...new Set(subIndustries)];
};
