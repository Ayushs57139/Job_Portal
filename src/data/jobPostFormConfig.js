...
// Multi-step form configuration (4 consolidated steps with progressive reveal)
export const formSteps = [
  {
    id: 'step1',
    title: 'Company & Job Basics',
    description: 'Tell us about your company and the role you\'re hiring for',
    fields: [
      {
        name: 'employerType',
  ...
  },
  {
    ...
    description: 'Where is the job and what are the requirements?',
    fields: [
      {
        name: 'jobState',
        label: 'Job State',
      ...
      {
        name: 'salaryMin',
        label: 'Salary per Annum (Minimum)',
        type: 'number',
      ...
      {
        name: 'salaryMax',
        label: 'Salary per Annum (Maximum)',
        type: 'number',
  ...
  {
    id: 'step3',
    title: 'Candidate Profile & Job Description',
    description: 'Define who you\'re looking for and describe the role',
    fields: [
      {
        name: 'jobDescription',
  ...
  {
    id: 'step4',
    title: 'Contact, Walk-in & Submit',
    description: 'Add contact details and optional walk-in information',
    fields: [
      {
        name: 'jobResponseMethod',
        label: 'Job Response Method',
        type: 'dropdown',
      ...
      {
        name: 'aboutClient',
        label: 'About Your Clients (For Consultancy)',
        type: 'textarea',
