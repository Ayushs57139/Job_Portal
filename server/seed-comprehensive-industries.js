...
// Comprehensive industry data as provided by user
const comprehensiveIndustryData = {
...
// Function to seed comprehensive industries
const seedComprehensiveIndustries = async () => {
  try {
    console.log('Starting comprehensive industry seeding...');
    
    // Clear existing industries
    await Industry.deleteMany({});
    console.log('Cleared existing industries');
    
    // Insert new comprehensive industries
    const industries = Object.entries(comprehensiveIndustryData).map(([name, subcategories]) => ({
      name,
      subcategories,
      isActive: true,
      createdAt: new Date(),
    ...
    console.log(`Successfully seeded ${industries.length} industries with comprehensive sub-industries`);
    
    // Display summary
    const totalSubIndustries = industries.reduce((total, industry) => total + industry.subcategories.length, 0);
    console.log(`Total sub-industries: ${totalSubIndustries}`);
    
    console.log('Comprehensive industry seeding completed successfully!');
...
const main = async () => {
  try {
    await connectDB();
    await seedComprehensiveIndustries();
...
module.exports = { seedComprehensiveIndustries, comprehensiveIndustryData };
