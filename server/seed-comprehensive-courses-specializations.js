...
const seedComprehensiveCoursesAndSpecializations = async () => {
  try {
    ...
    const diplomaCourses = [
      ...
      { name: 'Other', category: 'Other', level: 'Diploma', duration: '2-3 years', description: 'Other Diploma courses', createdBy: adminUser._id }
    ];
    ...
    const bachelorCourses = [
      ...
      { name: 'Other', category: 'Other', level: 'Graduate', duration: '3-4 years', description: 'Other Bachelor courses', createdBy: adminUser._id }
    ];
    ...
    const masterCourses = [
      ...
      { name: 'Dual Degree (B.E/B.Tech + M.E/M.Tech)', category: 'Engineering', level: 'Post Graduate', duration: '5 years', description: 'Dual Degree Engineering', createdBy: adminUser._id },
    ...
    const doctorateCourses = [
      ...
      { name: 'Other', category: 'Other', level: 'Doctorate', duration: '3-5 years', description: 'Other Doctorate courses', createdBy: adminUser._id }
    ];

    // Combine all courses
    const allCourses = [...itiCourses, ...diplomaCourses, ...bachelorCourses, ...masterCourses, ...doctorateCourses];
...
seedComprehensiveCoursesAndSpecializations();
