...
const seedComprehensiveSpecializations = async () => {
  try {
    ...
    const diplomaSpecializations = [
      ...
      { name: 'Other', field: 'Other', level: 'Graduate', description: 'Other Diploma specializations', createdBy: adminUser._id },
    ...
    const allSpecializations = [...itiSpecializations, ...diplomaSpecializations];
...
seedComprehensiveSpecializations();
