...
const AdminSidebar = ({ activeScreen, onNavigate, onClose }) => {
  ...
  const menuItems = [
    ...
    { id: 'faqs', label: 'FAQ Management', icon: 'help-circle-outline', screen: 'AdminFAQs' },
    ...
    { id: 'chatTemplates', label: 'Chat Templates', icon: 'list-outline', screen: 'AdminChatTemplates' },
    ...
    { id: 'paymentOptions', label: 'Payment Options', icon: 'wallet-outline', screen: 'AdminPaymentOptions' },
    { id: 'apiSettings', label: 'API Management', icon: 'key-outline', screen: 'AdminApiSettings' },
