...
const getStyles = (isMobile, isTablet) => StyleSheet.create({
  ...
  modalHeader: {
    ...
    paddingHorizontal: isMobile ? 20 : isTablet ? 32 : 44,
    paddingTop: isMobile ? 24 : isTablet ? 32 : 44,
  ...
  modalBody: {
    padding: isMobile ? 20 : isTablet ? 32 : 44,
    maxHeight: isMobile ? '70vh' : '60vh',
    backgroundColor: '#FFFFFF',
    overflow: 'hidden',
    ...(Platform.OS === 'web' && {
      maxHeight: isMobile ? 'calc(90vh - 150px)' : 'calc(85vh - 200px)',
    }),
  },
  detailRow: {
    flexDirection: 'row',
